...
std::unique_ptr<sample_app::QnnSampleApp> processCommandLine(int argc,
  ...
  // cachedBinaryPath = "../../build/context/best_sim.bin";
  // backEndPath = "/home/hq/qairt/qaisw-v2.37.1.250807093845_124904-auto/lib/x86_64-linux-clang/libQnnHtp.so";
  // inputListPaths = "/home/hq/hq/qnndemo/input_raw/input_list.txt";
  // systemLibraryPath = "/home/hq/qairt/qaisw-v2.37.1.250807093845_124904-auto/lib/x86_64-linux-clang/libQnnSystem.so";
  QNN_INFO("Model: %s", modelPath.c_str());
  QNN_INFO("Backend: %s", backEndPath.c_str());
  QNN_INFO("cachedBinaryPath: %s", cachedBinaryPath.c_str());
  QNN_INFO("systemLibraryPath: %s", systemLibraryPath.c_str());
  QNN_INFO("inputListPaths: %s", inputListPaths.c_str());
  loadFromCachedBinary = true;
